...
object EventSourcedActorOf {
  ...
  implicit final private[evolution] class SnapshotOps[S](val snapshot: SnapshotStore.Offer[S]) extends AnyVal {
  ...
  implicit final private[evolution] class EventStoreOps[F[_], E](val store: EventStore[F, E]) extends AnyVal {
